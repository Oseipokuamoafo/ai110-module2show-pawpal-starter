    ...
    for i, task in enumerate(st.session_state.tasks):
        ...
        with st.expander(
            ...
            with col1:
                ...
                st.write(f"**Priority:** {task.priority}/5 {'⭐' * task.priority}")
...
# Footer
st.divider()
st.caption("Built with ❤️ using Streamlit and Python | PawPal+ © 2024")
